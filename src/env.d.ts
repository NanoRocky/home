interface ImportMetaEnv {
  ...
  readonly VITE_SITE_AUTHOR_EN: string;
  readonly VITE_SITE_MAIN_NAME_EN: string;
  ...
  readonly VITE_DESC_HELLO_EN: string;
  readonly VITE_DESC_TEXT_EN: string;
  readonly VITE_DESC_HELLO_OTHER_EN: string;
  readonly VITE_DESC_TEXT_OTHER_EN: string;
