<template>
  <div class="devsettings">
    <el-collapse class="collapse" v-model="activeName" accordion>
      <el-collapse-item title="季节特效" name="1">
        <div class="item">
          <el-button
            ...
            >{{ store.showSnowfall ? "禁用" : "启用" }}冬日飘雪</el-button
          >
          <el-button
            plain
            class="el-button"
            ...
            >{{ store.showFirefly ? "禁用" : "启用" }}秋萤火虫</el-button
          >
          <el-button
            plain
            class="el-button"
            ...
            >{{ store.showLantern ? "禁用" : "启用" }}春节灯笼</el-button
          >
        </div>
      </el-collapse-item>
        ...
        <div class="item">
          ...
          >
            ...
            >
              ...
              <el-button plain class="el-button" native-type="submit" :disabled="!form.wallpaperId"
                >确定</el-button
              >
            </el-form-item>
          </el-form>
      ...
      <el-collapse-item title="语言设置" name="5">
        <div class="item">
          <span class="text">选择页面语言</span>
          <el-radio-group
            v-model="language"
            size="small"
            text-color="#FFFFFF"
          ...
          >
            ...
            <el-radio :value="'en-US'" border>英语</el-radio>
          </el-radio-group>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item title="检查版本更新" name="7">
        <div class="item">
          <div class="upver">
            版本号 v{{ versionInfo.version }}，{{ versTypeT }}，{{ versionInfo.channel }} 渠道，by
            {{ versionInfo.upa }} 。
          </div>
        </div>
        <div class="item">
